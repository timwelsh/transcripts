class Plan < ActiveRecord::Base
	...
	validates :name,uniqueness: true,length: { maximum: 20 ,message: "Plan name should be maximum of 10 characters long."}
	...
	# validates :description,length: { maximum: 50 ,message: "Description should be maximum of 20 characters long."}
end
